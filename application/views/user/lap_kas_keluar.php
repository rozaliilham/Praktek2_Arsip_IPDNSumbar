                ...
                <div class="col-md-12">
                    <div class="card card-primary card-outline">
                        <div class="card-header">
                            <form class="form-inline" action="<?php echo base_url('user/filter_kas_keluar'); ?>" method="post">
                        ...
                        <div class="card-body">
                            <div class="mb-3 font-weight-bold">Laporan kas hari ini tanggal : <?php $tanggal = date('Y/m/d');
