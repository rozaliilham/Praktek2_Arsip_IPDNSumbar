                                    ...
                                    <tbody>
                                        ...
                                        <?php foreach ($kas_keluar as $lu) : ?>
                                            <tr>
                                                ...
                                                <td>
                                                    <button type="button" class="tombol-edit btn btn-info btn-sm" data-id="<?php echo $lu['id_kas_keluar']; ?>" data-toggle="modal" data-target="#edit-user"><i class="fas fa-edit"></i></button>
                                                    <a href="<?php echo base_url('user/hapus_kas_keluar/' . $lu['id_kas_keluar']); ?>" class="tombol-hapus btn btn-danger btn-sm"><i class="fas fa-trash-alt"></i></a>
                                                </td>
                                            </tr>
                                        <?php endforeach; ?>
                                    </tbody>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="box-body">
                    <form action="<?php echo base_url('user/kas_keluar'); ?>" method="post" id="form_id">
...
<div class="modal fade" id="edit-user">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="box-body">
                    <form action="<?php echo base_url('user/edit_kas_keluar'); ?>" method="post" id="form_id">
...
<script>
    $('.tombol-edit').on('click', function() {
        ...
        $.ajax({
            url: '<?php echo base_url('user/get_kas_keluar'); ?>',
            data: {
