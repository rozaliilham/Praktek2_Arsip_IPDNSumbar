                                        ...
                                        <?php foreach ($kas_masuk as $lu) : ?>
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <a href="<?php echo base_url('user/hapus_kas_masuk/' . $lu['id_kas_masuk']); ?>" class="tombol-hapus btn btn-danger btn-sm"><i class="fas fa-trash-alt"></i></a>
                                                </td>
                                            </tr>
                                        <?php endforeach; ?>
                                    </tbody>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="box-body">
                    <form action="<?php echo base_url('user/kas_masuk'); ?>" method="post" id="form_id">
...
<div class="modal fade" id="edit-user">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="box-body">
                    <form action="<?php echo base_url('user/edit_kas_masuk'); ?>" method="post" id="form_id">
...
<script>
    $('.tombol-edit').on('click', function() {
        ...
        $.ajax({
            url: '<?php echo base_url('user/get_kas_masuk'); ?>',
            data: {
