               ...
               with font-awesome or any other icon font library -->
                ...
                <li class="nav-item has-treeview">
                    ...
                    <ul class="nav nav-treeview">
                        <li class="nav-item">
                            <a href="<?php echo base_url('user/kas_masuk'); ?>" class="nav-link">
                                <i class="far fa-circle nav-icon"></i>
                                <p>Kas Masuk</p>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="<?php echo base_url('user/kas_keluar'); ?>" class="nav-link">
                                <i class="far fa-circle nav-icon"></i>
                                <p>Kas Keluar</p>
                            </a>
                        </li>
                ...
                <li class="nav-item has-treeview">
                    ...
                    <ul class="nav nav-treeview">
                        <li class="nav-item">
                            <a href="<?php echo base_url('user/lap_kas_masuk'); ?>" class="nav-link">
                                <i class="far fa-circle nav-icon"></i>
                                <p>Laporan Kas Masuk</p>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="<?php echo base_url('user/lap_kas_keluar'); ?>" class="nav-link">
                                <i class="far fa-circle nav-icon"></i>
